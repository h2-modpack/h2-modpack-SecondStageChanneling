# Second Stage Channeling Fix

> A bug fix and quality-of-life improvement that removes the second channeling stage from two abilities, making them faster and more responsive.

## Features

- Reworks Apollo's "Glorious Disaster" and the Staff's "Giga Moonburst" hammer upgrade.
- The bonus damage from the second channeling stage is baked into the first stage.
- This removes the need to channel the abilities a second time, making them feel better to use.
